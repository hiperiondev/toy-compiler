#ifndef _TOY_AST_NODE_H_
#define _TOY_AST_NODE_H_
...
typedef enum Toy_ASTNodeType {
    ...
    TOY_AST_NODE_FN_DECL,           // contain identifier literal, arguments node, returns node, block node
